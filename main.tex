...
\item [En la segunda premisa menor] \emph{tu interpretación de lo que hacemos los católicos es errónea}: Interpretas que los católicos le damos adoración a los objetos materiales, sin comprender que nuestra intención va a Dios mismo.
...
\noindent
A lo que te respondo ampliando tus propias palabras:

\begin{quote}
\emph{Me escribiste: «en la Biblia no hay contradicciones, sólo aparentes»; de la misma forma, entre la Biblia y la Tradición no hay contradicciones. La Palabra de Dios no puede contradecirse, sea ésta oral o escrita, pues proviene del mismo Cristo; allí donde tu mente ve una contradicción, lo que hay es una invitación a profundizar en el Misterio insondable de Dios.}
\end{quote}
...
\begin{quote}
\textbf{La única contradicción es la que existe entre \emph{lo que tú entiendes que es la Tradición católica} (en este caso, la veneración de las imágenes) y \emph{tu interpretación privada (2 Pe 1,10;3,16) de Ex 20,4-6}}
\end{quote}
