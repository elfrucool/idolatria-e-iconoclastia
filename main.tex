...
\begin{quote}
\emph{Vamos a suponer que la tradición católica contradijera las escrituras, ¿sería válida como forma de vivir según Dios?, donde \emph{contradecir} significa «hacer que se violenten órdenes explicitas o modifique textualmente la palabra de Dios», por ejemplo: Ex 20,4-6/Dt 5,8-10} contra  <foto del papa arrodillado ante imagen>,\footnote{El enlace era el siguiente: http://diosenlanoticia.org/wp-content/uploads/papa-arrodillado-ante-imagen.jpg} ¿qué dices?
\end{quote}
