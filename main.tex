...
\noindent
En esta ocasi\'on voy a hablar s\'olamente en t\'erminos humanos. El sentido espiritual y b\'{i}blico es tan extenso y profundo que requerir\'{i}a un tratado aparte.

Antes de contarte mi experiencia personal, perm\'{i}teme relatarte dos ejemplos actuales en el plano internacional:

\begin{description}
\item[Asia Bibi (Pakistán)\footnote{http://asiabibi.org/?lang=es}]
    Desde 2009 está en el corredor de la muerte por confesar su fe y negarse a convertirse al islam.%
