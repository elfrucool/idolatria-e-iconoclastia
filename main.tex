...
\noindent
Por lo tanto, \emph{\textbf{LA PROHIBICI\'ON DE IM\'AGENES EN DT 4,15-20 EST\'A SUJETA A QUE EL PUEBLO DE ISRAEL NO HA VISTO A DIOS}}.

Si hubiera visto alguna figura en el Horeb, la advertencia no tendr\'{i}a lugar. Como en el caso de la novia que no ha visto el rostro del novio y que por tanto no deber\'{i}a tener fotograf\'{i}as de hombre alguno para ser fiel a su prometido, igual Israel no debe tener imagen alguna para no corromperse.
