...
En el apartado anterior lo dedujimos de la \emph{estructura interna} de Ex 20,4-5b; ahora lo deduciremos del \emph{contexto inmediato} (externo), es decir, de Ex 20,5c-6 y Ex 20,4.
...
As\'{i} que ir en pos de otros dioses es para el creyente, lo mismo que para la esposa ir en pos de otros hombres. Es como si Dios dijera: \emph{no tengas fotograf\'{i}as de otros pretendientes}. Esta analog\'{i}a de las fotograf\'{i}as nos servir\'a m\'as adelante, no la pierdas de vista.
...
\subsubsection{Incorporando Ex 20,4 al an\'alisis}

No \'unicamente Ex 20,5c-6 refuerza la idea de que Ex 20,4-5b se refiere a la adoraci\'on de otros dioses. Tambi\'en Ex 20,4 lo sugiere. El texto sigue una estructura circular en la que:
...
Seg\'un Dt 5,22 fueron escritos en dos tablas de piedra. Pero hay dos cosas que la Biblia no precisa: a) de qu\'e forma se distribuyeron las \emph{palabras} en las tablas y b) la numeraci\'on exacta de las palabras.

Algunos discuten si las diez palabras se distribuyeron entre las dos tablas o bien si cada una de las tablas conten\'{i}a todo el dec\'alogo como si fuera un contrato con dos copias: una para Dios y otra para el pueblo.\footnote{Estos temas son bastante extensos y muchos aspectos son controvertibles; as\'{i} que me centrar\'e en lo esencial para nuestra discusi\'on.}
...
\noindent
Llama la atenci\'on esta \emph{justificaci\'on} porque \emph{no alude ning\'un motivo teol\'ogico} sino m\'as bien el que sean diez los mandamientos. Este dato nos revela dos cosas: a) que Or\'{i}genes no ve objeci\'on \emph{teol\'ogica} a que Ex 20,3 forme \emph{un} mandamiento con Ex 20,4-6 y b) que en el tema de Ex 20,17 se mantiene en la misma l\'{i}nea que el juda\'{i}smo.
...
\subsubsection{Par\'entesis: acerca de los cap\'{i}tulos y vers\'{i}culos}

Puede ser que a estas alturas todav\'{i}a sientas demasiado forzado el argumento, pues claramente Dt 5,18 es \emph{un} solo vers\'{i}culo.
...
\item \textbf{El \emph{motivo} es para salvaguardar la libertad de Dios, que no est\'a sometido (por medio de im\'agenes) al hombre. M\'as exactamente, que al pueblo le quede muy claro que a Dios no se le puede controlar.}
...
\noindent
He resaltado la idea que considero m\'as importante: \emph{el motivo para prohibir la representaci\'on de Dios es quitarle la tentaci\'on al hombre de querer <<controlar>> a Dios}. Esto queda confirmado por lo que pas\'o con la efigie de Mik\'a (Jue 17,1-13;18,18-31), pues terminaron \emph{reduciendo} al Dios alt\'{i}simo a un <<dios>> atrapado en una imagen.
...
?`Esta prohibici\'on sigue siendo v\'alida en el Nuevo Testamento?

S\'olo parcialmente. Con la Encarnaci\'on de la Segunda Persona de la Sant\'{i}sima Trinidad, el Dios inefable, el \emph{absolutamente otro}, el Dios trascendente, el inabarcable y absolutamente libre \emph{se ha hecho visible}.

%abundar un poco mas sobre como Dios se metio en la historia y se hizo fragil y se puso a nuestra disposicion

%la libertad de Dios sigue en riesgo

%la nueva economia de las imagenes (CIC)

%la intencion remite al original (II Nicea, 787)

%comparacion con la foto
