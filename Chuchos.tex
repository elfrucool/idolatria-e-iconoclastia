...
% \emph{Someter} a Dios y ponerlo a nuestro servicio es una tentaci\'on permanente. Con o sin im\'agenes. Puede ser que \emph{exteriormente} se est\'e reverenciando la imagen, pero \emph{interiormente} se quiera \emph{forzar} a Dios a cumplir los propios deseos.

% Pongo tres casos a tu consideraci\'on:

% \begin{enumerate}
% \item La efigie de Mik\'a (Jue 17,1-13;18,18-31)
% \item La segunda tentaci\'on de Jes\'us (Mt 4,5-7)
% \item El fariseo y el publicano (Lc 18,9-14)
% \end{enumerate}

% \subsubsection{La efigie de Mik\'a (Jue 17,1-13;18,18-31)}
% \subsubsection{La segunda tentaci\'on de Jes\'us (Mt 4,5-7)}
% \subsubsection{El fariseo y el publicano (Lc 18,9-14)}
